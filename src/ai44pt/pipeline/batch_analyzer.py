...
from ..prompt_engineering.prompts import build_system_prompt, build_user_prompt, format_questions_prompt
from ..handlers.document_reader import DocumentReader
from ..handlers.response_parser import ResponseParser
...
class BatchAnalyzer:
    ...
    def _build_prompt(self, coding_task_text: str, executive_summary_text: str, main_body_text: str, article_text: str, question_order: List[int]) -> Tuple[str, str]:
        ...
        questions_prompt = format_questions_prompt(
            self.config, question_order, self.config.QUESTION_TEXTS, self.config.ENABLE_SHUFFLE
        )
